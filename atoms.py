...
class Atoms(object):
    ...
    def __init__(self, symbols=None,
                 ...
                 constraint=None,
                 calculator=None,
                 info=None,castep_neb=None,
                 system_energy=None,system_forces=None):
        ...
        self.castep_neb = castep_neb
        self.energy = system_energy
        self.forces = system_forces
    ...
    def get_potential_energy(self, force_consistent=False,
        ...
        if self.castep_neb:
            if force_consistent:
                print ('WARNING force consistent not supported!')
            energy = self.energy        
        elif self._calc is None:
            raise RuntimeError('Atoms object has no calculator.')
        elif force_consistent:
